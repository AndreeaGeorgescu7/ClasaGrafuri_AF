...
private:
    ...
    vector <int> current_time_stamp,tata,rang,st,dr;
...
public:
    ...
    void ciclu_eulerian(int s,int &poz,vector<int>&muchii_viz,vector<int>& drum,vector<vector<pair<int,int>>>v);
...
void GrafNeorientat::ciclu_eulerian(int s,int &poz,vector<int>&muchii_viz,vector<int>&drum,vector<vector<pair<int,int>>>v)
{
